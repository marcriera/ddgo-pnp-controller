...
pub const DEVICE_DESCRIPTOR: DeviceDescriptor = DeviceDescriptor {
    ...
    i_product: "Densha de Go! Plug & Play (SAT Two Handle mode)",
    i_serial_number: "TC-5175290",
};
...
pub fn update_gadget(state: &mut ControllerState) {
    ...
    match state.power {
        0 => {
            buttons2.insert(Buttons2::TRIANGLE | Buttons2::L1);
        }
        1 => {
            buttons2.insert(Buttons2::SQUARE | Buttons2::L1);
        }
        2 => {
            buttons2.insert(Buttons2::L1);
        }
        3 => {
            buttons2.insert(Buttons2::TRIANGLE | Buttons2::SQUARE);
        }
        4 => {
    ...
    match state.brake {
        0 => {
            buttons1.insert(Buttons1::DOWN | Buttons1::LEFT);
        ...
        3 => {
            ...
            buttons2.insert(Buttons2::R2 | Buttons2::L2);
        }
        4 => {
            buttons1.insert(Buttons1::LEFT);
            buttons2.insert(Buttons2::R2);
